...
function validaDataNascimento(input) {
  ...
  input.setCustomValidity(mensagem); // mensagem de validação do campo input (parecido com o title que coloca dentro da tag input no html)
}
...
function validaCPF(input) {
  const cpfFormatado = input.value.replace(/\D/g, ""); // pega tudo que não é número, e substitui por vazio
  let mensagem = "";
